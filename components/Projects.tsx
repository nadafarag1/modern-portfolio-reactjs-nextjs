...
<div className="h-screen relative flex overflow-hidden text-left flex-col
  ...
  <ul className="cards flex scroll scroll-snap">
    <li className="card flex">
      <div>
        <h3 className="card-title">Project 1</h3>
        <img src="https://cdn.pixabay.com/photo/2019/01/17/19/11/login-3938432_960_720.jpg" width={927} height={455} decoding='async' loading='lazy' alt=""/>
        <div className="card-content">
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
        </div>
      </div>
